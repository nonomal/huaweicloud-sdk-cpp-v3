...
#ifndef HUAWEICLOUD_SDK_RDS_V3_MODEL_ShowMySqlProxySlowLogListRequest_H_
#define HUAWEICLOUD_SDK_RDS_V3_MODEL_ShowMySqlProxySlowLogListRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_RDS_V3_EXPORT  ShowMySqlProxySlowLogListRequest
    : public ModelBase
{
public:
    ShowMySqlProxySlowLogListRequest();
    virtual ~ShowMySqlProxySlowLogListRequest();
    ...
    /////////////////////////////////////////////
    /// ShowMySqlProxySlowLogListRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ShowMySqlProxySlowLogListRequest& dereference_from_shared_ptr(std::shared_ptr<ShowMySqlProxySlowLogListRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_RDS_V3_MODEL_ShowMySqlProxySlowLogListRequest_H_
