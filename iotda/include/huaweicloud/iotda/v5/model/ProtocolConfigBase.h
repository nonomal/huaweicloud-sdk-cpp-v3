...
#ifndef HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ProtocolConfigBase_H_
#define HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ProtocolConfigBase_H_
...
/// 泛协议配置信息
/// </summary>
class HUAWEICLOUD_IOTDA_V5_EXPORT  ProtocolConfigBase
    : public ModelBase
{
public:
    ProtocolConfigBase();
    virtual ~ProtocolConfigBase();
...
#endif // HUAWEICLOUD_SDK_IOTDA_V5_MODEL_ProtocolConfigBase_H_
