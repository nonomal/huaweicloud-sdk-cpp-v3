...
Object ResourceInstance::getResourceDetail() const
{
    return resourceDetail_;
}

void ResourceInstance::setResourceDetail(const Object& value)
{
...
std::string ResourceInstance::getWorkspaceId() const
{
    return workspaceId_;
}

void ResourceInstance::setWorkspaceId(const std::string& value)
{
    workspaceId_ = value;
    workspaceIdIsSet_ = true;
}

bool ResourceInstance::workspaceIdIsSet() const
{
    return workspaceIdIsSet_;
}

void ResourceInstance::unsetworkspaceId()
{
    workspaceIdIsSet_ = false;
}
...
std::vector<TmsTagResp>& ResourceInstance::getTags()
{
    return tags_;
}

void ResourceInstance::setTags(const std::vector<TmsTagResp>& value)
{
    tags_ = value;
    tagsIsSet_ = true;
}
