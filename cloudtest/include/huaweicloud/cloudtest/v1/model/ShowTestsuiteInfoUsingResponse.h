...
#ifndef HUAWEICLOUD_SDK_CLOUDTEST_V1_MODEL_ShowTestsuiteInfoUsingResponse_H_
#define HUAWEICLOUD_SDK_CLOUDTEST_V1_MODEL_ShowTestsuiteInfoUsingResponse_H_
...
/// Response Object
/// </summary>
class HUAWEICLOUD_CLOUDTEST_V1_EXPORT  ShowTestsuiteInfoUsingResponse
    : public ModelBase, public HttpResponse
{
public:
    ShowTestsuiteInfoUsingResponse();
    virtual ~ShowTestsuiteInfoUsingResponse();
    ...
    /////////////////////////////////////////////
    /// ShowTestsuiteInfoUsingResponse members
    ...
    AlertConfigVo getAlertConfig() const;
    bool alertConfigIsSet() const;
    void unsetalertConfig();
    void setAlertConfig(const AlertConfigVo& value);
    ...
    std::vector<TestCaseTemplateVo>& getTestCaseAlertGroups();
    bool testCaseAlertGroupsIsSet() const;
    void unsettestCaseAlertGroups();
    void setTestCaseAlertGroups(const std::vector<TestCaseTemplateVo>& value);
...
protected:
    ...
    std::vector<TestCaseTemplateVo> testCaseAlertGroups_;
    bool testCaseAlertGroupsIsSet_;
...
#endif // HUAWEICLOUD_SDK_CLOUDTEST_V1_MODEL_ShowTestsuiteInfoUsingResponse_H_
