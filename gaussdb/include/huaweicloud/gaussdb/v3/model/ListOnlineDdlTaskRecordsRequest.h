...
#ifndef HUAWEICLOUD_SDK_GAUSSDB_V3_MODEL_ListOnlineDdlTaskRecordsRequest_H_
#define HUAWEICLOUD_SDK_GAUSSDB_V3_MODEL_ListOnlineDdlTaskRecordsRequest_H_
...
/// Request Object
/// </summary>
class HUAWEICLOUD_GAUSSDB_V3_EXPORT  ListOnlineDdlTaskRecordsRequest
    : public ModelBase
{
public:
    ListOnlineDdlTaskRecordsRequest();
    virtual ~ListOnlineDdlTaskRecordsRequest();
    ...
    /////////////////////////////////////////////
    /// ListOnlineDdlTaskRecordsRequest members
...
protected:
    ...
    RTTR_ENABLE()
public:
    ListOnlineDdlTaskRecordsRequest& dereference_from_shared_ptr(std::shared_ptr<ListOnlineDdlTaskRecordsRequest> ptr) {
        return *ptr;
    }
#endif
};
...
#endif // HUAWEICLOUD_SDK_GAUSSDB_V3_MODEL_ListOnlineDdlTaskRecordsRequest_H_
