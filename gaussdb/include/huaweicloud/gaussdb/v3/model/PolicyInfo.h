...
#ifndef HUAWEICLOUD_SDK_GAUSSDB_V3_MODEL_PolicyInfo_H_
#define HUAWEICLOUD_SDK_GAUSSDB_V3_MODEL_PolicyInfo_H_
...
/// 
/// </summary>
class HUAWEICLOUD_GAUSSDB_V3_EXPORT  PolicyInfo
    : public ModelBase
{
public:
    PolicyInfo();
...
#endif // HUAWEICLOUD_SDK_GAUSSDB_V3_MODEL_PolicyInfo_H_
