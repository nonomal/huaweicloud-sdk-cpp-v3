...
web::json::value ScheduleEventInfo::toJson() const
{
    ...
    if(eventEntitiesIsSet_) {
        val[utility::conversions::to_string_t("event_entities")] = ModelBase::toJson(eventEntities_);
    }
...
bool ScheduleEventInfo::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("event_entities"))) {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t("event_entities"));
        if(!fieldValue.is_null())
        {
            std::vector<EventEntity> refVal;
            ok &= ModelBase::fromJson(fieldValue, refVal);
            setEventEntities(refVal);
        }
    }
    return ok;
}
...
std::string ScheduleEventInfo::getCategory() const
{
    return category_;
}

void ScheduleEventInfo::setCategory(const std::string& value)
{
    category_ = value;
    categoryIsSet_ = true;
}

bool ScheduleEventInfo::categoryIsSet() const
{
    return categoryIsSet_;
}

void ScheduleEventInfo::unsetcategory()
{
    categoryIsSet_ = false;
}
...
std::string ScheduleEventInfo::getUpdatedTime() const
{
    return updatedTime_;
}

void ScheduleEventInfo::setUpdatedTime(const std::string& value)
{
    updatedTime_ = value;
    updatedTimeIsSet_ = true;
}

bool ScheduleEventInfo::updatedTimeIsSet() const
{
    return updatedTimeIsSet_;
}

void ScheduleEventInfo::unsetupdatedTime()
{
    updatedTimeIsSet_ = false;
}
...
std::string ScheduleEventInfo::getExtendInfo() const
{
    return extendInfo_;
}

void ScheduleEventInfo::setExtendInfo(const std::string& value)
{
    extendInfo_ = value;
    extendInfoIsSet_ = true;
}

bool ScheduleEventInfo::extendInfoIsSet() const
{
    return extendInfoIsSet_;
}

void ScheduleEventInfo::unsetextendInfo()
{
    extendInfoIsSet_ = false;
}
...
bool ScheduleEventInfo::executionTimeWindowIsSet() const
{
    return executionTimeWindowIsSet_;
}

void ScheduleEventInfo::unsetexecutionTimeWindow()
{
    executionTimeWindowIsSet_ = false;
}

std::vector<EventEntity>& ScheduleEventInfo::getEventEntities()
{
    return eventEntities_;
}

void ScheduleEventInfo::setEventEntities(const std::vector<EventEntity>& value)
{
    eventEntities_ = value;
    eventEntitiesIsSet_ = true;
}

bool ScheduleEventInfo::eventEntitiesIsSet() const
{
    return eventEntitiesIsSet_;
}

void ScheduleEventInfo::unseteventEntities()
{
    eventEntitiesIsSet_ = false;
}
